---
title: 'Introducing Tailwind Nextjs Starter Index'
date: '2021-01-12'
lastmod: '2021-02-01'
tags: ['next-js', 'tailwind', 'guide']
draft: false
summary: 'Looking for a performant, out of the box template, with all the best in web technology to support your blogging needs? Checkout the Tailwind Nextjs Starter Index template.'
...
- [Demo Index](https://tailwind-nextjs-starter-blog.vercel.app/) - this repo
...
`components/social-icons` - to add other icons, simply copy an svg file from [Simple Icons](https://simpleicons.org/) and map them in `[page].js`. Other icons use [heroicons](https://heroicons.com/).
...
```
---
title: 'Introducing Tailwind Nexjs Starter Index'
date: '2021-01-12'
lastmod: '2021-01-18'
tags: ['next-js', 'tailwind', 'guide']
draft: false
